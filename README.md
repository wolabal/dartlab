...
**현재 (v0.2.1)** — 문서 파싱 + 기업 간 비교 + AI 기업분석
...
- **dartlab ui**: Ollama 기반 AI 기업분석 웹 인터페이스 (로컬 LLM)

**다음 단계** — LLM Provider 확장 + 시장 전체 분석
- OpenAI(GPT), Anthropic(Claude) 등 클라우드 LLM provider 추가
...
- [x] AI 기업분석 웹 인터페이스 (dartlab ui) — Ollama 로컬 LLM
