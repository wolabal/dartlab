...
from dartlab.engines.dart.docs.finance.companyOverviewDetail.parser import parseCompanyInfo
from dartlab.engines.dart.docs.finance.companyOverviewDetail.types import CompanyOverviewDetailResult
